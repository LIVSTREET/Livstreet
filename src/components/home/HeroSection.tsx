          ...
          <div className="pt-3 space-y-3">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <Button
                ...
                size="lg"
                asChild
                className="group rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/90 w-full sm:w-auto"
              >
              ...
              <Button
                ...
                size="lg"
                asChild
                className="rounded-full border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary w-full sm:w-auto"
              >
                <Link to="/om-produktet">Lær mer</Link>
              </Button>
            </div>
            <p className="text-xs md:text-sm text-primary-foreground/85 drop-shadow">
